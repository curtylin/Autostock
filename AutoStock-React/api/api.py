...
scheduler.add_job(func=generateBot, trigger="interval", days=7, hour = 8, minute = 0)
scheduler.add_job(func=enterBotsIntoComps, trigger="interval", days=7, hour=8, minute = 30)
