...
function SignInSide() {
  ...
  var handleSubmit = function (event) {
    ...
    var info = {
      email:
        (_a = data.get("email")) === null || _a === void 0
          ? void 0
          : _a.toString(),
      password:
        (_b = data.get("password")) === null || _b === void 0
          ? void 0
          : _b.toString(),
    }
    setEmail(info.email)
  ...
  return React.createElement(
    ...
    React.createElement(
      Grid_1["default"],
      { container: true, component: "main", sx: { height: "100vh" } },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "h1",
              { style: { fontSize: "5em", color: "#FFFFFF" } },
              "AUTO"
            ),
            React.createElement(
              "h1",
              { style: { fontSize: "5em", color: "#059A76" } },
              "STOCK"
            )
          ),
          React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Link_1["default"],
                  { href: "/app/createaccount", variant: "body2" },
