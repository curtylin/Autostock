    ...
    <Layout>
      ...
      <h3>
        {username == "" ? (
          <>
            First, you need to{" "}
            <Link to="/app/edituser">set a username here.</Link>
          </>
        ) : (
          <>
            Welcome {username}!<br></br>
            Looks like you are already have already set a username! If you would
            like to change it, go to the "
            <Link to="/app/edituser">Edit Account</Link>" tab on the upper right
            corner.
          </>
        )}
      </h3>
      ...
      <p>
        ...
        <Link to="/app/createalgorithm">creating an algorithm.</Link>
      </p>
      ...
      <p>
        Be sure to backtest your algorithm against historical data. Here is
        where you can see if some parts of the algorithm needs to be changed for
        a better yield.
      </p>
      <br></br>
      <img src="https://i.imgur.com/ZxRKzHu.gif"></img>
      ...
      <p>
        Once you have saved your algorithm, remember to save it and your
        algorithm will be available for you to see in the "
        <Link to="/app/myalgorithm">My Algorithms</Link>" page. Here, you can
        edit, share, and delete your algorithm. <br></br>
        <br></br> Please note: There will only be a day gain IF and only if you
      ...
      <p>
        Once you are happy with your algorithm, you can also enter it into a
        competition that you are interested in. You can do this by going to the
        "<Link to="/app/competition">Competitions</Link>" page. Make sure you
