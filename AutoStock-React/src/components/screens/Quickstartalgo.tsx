...
const QuickStartGuide = () => {
    ...
    return (
        <Layout>
            ...
            <p>
                Now we must start with the entry portion of the strategy or rules that signal when to buy or sell. 
                ...
                <br></br>
                <br></br>
                In the example above, we selected <Link to="https://www.investopedia.com/terms/s/sma.asp">SMA, or Simple moving average</Link>. It is the most basic indicator you can have. It essentially calculates the average of a selected range.
                <br></br>
            ...
            <p>Next portion of the entry is to give it another indicator or strategy to compare to. This will determine the different entry rules on when to buy and sell. <br></br>
            In the example, we have it so that we are comparing the 20 day open average and the 10 day open average. In other words, if the 20 day open average is higher than the 10 day open, we will execute a buy order. </p>
            ...
            <p>You are given an action that will perform when the conditions that are meant in the Entry/Entries are met. <br></br>

                <Link to="https://www.investopedia.com/terms/s/sma.asp">For more information about buy and sell orders</Link>.  </p>
